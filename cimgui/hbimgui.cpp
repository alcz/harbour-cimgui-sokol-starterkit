...
HB_FUNC( IGITEMADD )
{
   ...
   ImGuiItemAddFlags flags = ( ImGuiItemAddFlags ) hb_parni( 4 );
   bool ret = igItemAdd(bb,id,nav_bb,flags);
   hb_retl( ret );
}

/* void igItemFocusable(ImGuiWindow* window,ImGuiID id) */
HB_FUNC( IGITEMFOCUSABLE )
{
   ImGuiWindow* window = ( ImGuiWindow* ) hb_parptr( 1 );
   ImGuiID id = ( ImGuiID ) hb_parni( 2 );
   igItemFocusable(window,id);
}
