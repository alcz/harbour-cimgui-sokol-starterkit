...
{
   ImDrawList* ret = igGetBackgroundDrawListNil();
   hb_retptr( ( void * ) ret );
}
...
HB_FUNC( IGGETBACKGROUNDDRAWLISTVIEWPORTPTR )
{
   ...
   ImDrawList* ret = igGetBackgroundDrawListViewportPtr(viewport);
   hb_retptr( ( void * ) ret );
}
...
{
   ImGuiViewport* viewport = ( ImGuiViewport* ) hb_parptr( 1 );
   ImDrawList* ret = igGetForegroundDrawListViewportPtr(viewport);
   hb_retptr( ( void * ) ret );
}
...
HB_FUNC( IGTABLESETCOLUMNENABLED )
{
   ...
   bool enabled = hb_parl( 2 );
   igTableSetColumnEnabled(column_n,enabled);
}
...
static void(*s_ImGuiViewport_fields[])( ImGuiViewport * ) = { s_ImGuiViewport_getFlags, s_ImGuiViewport_getPos, s_ImGuiViewport_getSize, s_ImGuiViewport_getWorkPos, s_ImGuiViewport_getWorkSize };
